...
{
  class SiegeEnginePrototypeDisplay : ModDisplay
  {
    ...
    public override void ModifyDisplayNode(UnityDisplayNode node)
    {
      ...
      SetMeshOutlineColor(node, new Color(2f / 255, 11f / 255, 12f / 255),2);
      SetMeshOutlineColor(node, new Color(2f / 255, 11f / 255, 12f / 255),3);
      SetMeshOutlineColor(node, new Color(2f / 255, 11f / 255, 12f / 255),4);
      SetMeshOutlineColor(node, new Color(2f / 255, 11f / 255, 12f / 255),7);
      SetMeshOutlineColor(node, new Color(2f / 255, 11f / 255, 12f / 255),8);
      SetMeshOutlineColor(node, new Color(229f / 255, 0f / 255, 168f / 255),9);
